...
artix_base_install() {
    ...
    echo 'amd-ucode artix-keyring artix-mirrorlist autoconf automake base bison elogind-openrc fakeroot flex gcc groff intel-ucode iptables-nft libtool linux-firmware m4 make memtest86+ mkinitcpio openbsd-netcat opendoas openntpd-openrc openrc pacman patch pkgconf texinfo util-linux which'
}
